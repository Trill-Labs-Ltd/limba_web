...
export const metadata: Metadata = {
  ...
  description:
    'Privacy Policy for Limba - Learn how we collect, use, and protect your personal data. We process health-related information only with your explicit consent. Learn how we use third-party AI services to personalise your experience.',
}
        ...
        <div className={`${TAILWIND_CLASSES.container} max-w-4xl`}>
          <div className="bg-white border border-gray-100 rounded-lg shadow-sm p-8 lg:p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 text-sm text-gray-500 mb-8 pb-8 border-b border-gray-100">
              <p>Last updated: 14 March 2026</p>
              <p>Version 1.2</p>
            </div>
