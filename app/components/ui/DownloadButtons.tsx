  ...
  return (
    <div className={`flex flex-col sm:flex-row items-center ${justifyClass} gap-3 w-full ${className}`}>
      <a
        ...
        className="w-full sm:w-48 inline-flex items-center justify-center gap-3 bg-black hover:bg-gray-800 text-white px-5 py-3.5 rounded-2xl transition-all duration-200 hover:scale-[1.02] active:scale-95 shadow-md"
      >
        <svg
        ...
        <span className="flex flex-col leading-tight text-left">
          <span className="text-[10px] font-normal opacity-70 tracking-wide uppercase">Download on the</span>
      ...
      >
        ...
        <span className="flex flex-col leading-tight text-left">
          <span className="text-[10px] font-normal opacity-70 tracking-wide uppercase">Get it on</span>
